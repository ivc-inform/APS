...
lazy val webUI = Project(id = "web-ui", base = file("web-ui")).
  enablePlugins(
    ...
    jsDependencies ++= Seq(
        "org.webjars" % "jquery" % "1.5.2" / "1.5.2/jquery.js",
        "org.webjars" % "jquery-ui" % "1.8.21" / "1.8.21/jquery-ui.js",
        "org.webjars.bower" % "datejs" % "1.0.0-rc3" / "1.0.0-rc3/build/date-ru-RU.js"
    ),
