...
isc.A.detailFields=["Id","Type","ParentId",
                     "LastModifiedDate","LastModifiedById","LastActivityDate",
                     "CreatedDate","CreatedById"];
isc.A.hiddenFields=["SystemModstamp"];
isc.B.push(isc.A.getHeaderData=function isc_SForce_getHeaderData(dsRequest){
        var headerData={};
...
,isc.A.login=function isc_SForce_login(userName,password,callback){
...
,isc.A.loginReply=function isc_SForce_loginReply(data,xmlDoc,rpcResponse,wsRequest){
...
,isc.A.ensureLoggedIn=function isc_SForce_ensureLoggedIn(callback,dismissable,properties){
...
,isc.A.getEntityList=function isc_SForce_getEntityList(callback){
...
,isc.A.describeGlobalReply=function isc_SForce_describeGlobalReply(data){
        this.fireCallback(this._describeGlobalCallback,"list",[data]);
    }
,isc.A.getEntity=function isc_SForce_getEntity(objectType,callback){
        var service=this;
...
,isc.A.describeObjectReply=function isc_SForce_describeObjectReply(data,objectType,callback){
...
,isc.A.convertSchema=function isc_SForce_convertSchema(sfSchema,ID){
...
,isc.A.deploySControl=function isc_SForce_deploySControl(name,code){
...
,isc.A.installSControl=function isc_SForce_installSControl(name,code,sControls,sControlDS){
...
,isc.A.getSControlHTML=function isc_SForce_getSControlHTML(code){
...
isc.D=isc._funcClasses;
isc.D[isc.C]=isc.A.Class;
isc.B.push(isc.A.transformData=function isc_SFResultSet_transformData(newData,dsResponse){
        this.context=this.context||{};
        this.context.queryLocator=dsResponse.queryLocator;
    }
,isc.A.setCriteria=function isc_SFResultSet_setCriteria(newCriteria){
...
isc.B.push(isc.A.transformRequest=function isc_SFDataSource_transformRequest(dsRequest){
...
,isc.A.transformResponse=function isc_SFDataSource_transformResponse(dsResponse,dsRequest,xmlData){
...
,isc.A.fetchData=function isc_SFDataSource_fetchData(criteria,callback,requestProperties,loggedIn){
        var ds=this;
...
,isc.A.convertValidationErrors=function isc_SFDataSource_convertValidationErrors(xmlData){
