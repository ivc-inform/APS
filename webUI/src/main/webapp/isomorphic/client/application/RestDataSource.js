...
isc.RestDataSource.addProperties({
    ...
    transformRequest : function (dsRequest) {
        ...
        if (protocol == "postMessage") {
            ...
            if (dsRequest.exportAs != null) params.exportAs = dsRequest.exportAs;
            if (dsRequest.exportFilename != null) params.exportFilename = dsRequest.exportFilename;
            if (dsRequest.exportPath != null) params.exportPath = dsRequest.exportPath;
            if (dsRequest.exportToFilesystem != null) params.exportToFilesystem = dsRequest.exportToFilesystem;
            //</editor-fold>
