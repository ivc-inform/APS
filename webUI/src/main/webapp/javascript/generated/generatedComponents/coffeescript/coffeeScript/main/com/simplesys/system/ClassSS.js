(function() {
  ...
  isc.Class.addProperties({
    getIdentifier: function() {
      return this.identifier || this.getID();
    },
    getComment: function() {
      var title;
      title = this.title;
      if ((title != null ? title.toLowerCase().indexOf("untitled") : void 0) === -1) {
        title = void 0;
      }
      return this.comment || title || this.getClassName();
    }
  });
  ...
  isc.Class.addClassProperties({
    addGlobalSS: function(propName, propValue) {
      if ((propName != null) && (propValue != null)) {
        simpleSyS.objects[propName] = propValue;
      }
    },
    getObjectSS: function(identifier) {
      return simpleSyS.objects[identifier];
    },
    isNullOrUndefigned: function(obj) {
      return obj == null;
    },
