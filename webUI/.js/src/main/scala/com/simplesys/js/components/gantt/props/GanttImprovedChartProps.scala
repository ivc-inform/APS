...
//                                                                        implicit def toOpt[T](x:T):Option[T] = Some(x)
                                                                        //g.AddTaskItem(new TaskItemExt(pID = 0, pName = "Вариант 1", pClass = ggroupblack, pRes = "Вариант 1", pGroup = Group.standardGroupTask, pComp = 100, pParent = 0)
...
//                                                                        g.AddTaskItem(new TaskItemExt(pID = 122, pName = "Task Variables", pStart = "2016-03-06 00:00".toLDT, pEnd = "2016-03-11 00:00".toLDT, pClass = gtaskred, pRes = "Brian", pComp = 60, pParent = 12, pOpen = Opening.open, pDepend = Seq(Depend(121))))
...
//                                                                        g.AddTaskItem(new TaskItemExt(pID = 124, pName = "Task Functions", pStart = "2016-03-09 00:00".toLDT, pEnd = "2016-03-29 00:00".toLDT, pClass = gtaskred, pRes = "Anyone", pComp = 60, pParent = 12, pOpen = Opening.open, pDepend = Seq((123).SS), pCaption = "This is a caption"))
//                                                                        g.AddTaskItem(new TaskItemExt(pID = 2, pName = "Create HTML Shell", pStart = "2016-03-24 00:00".toLDT, pEnd = "2016-03-24 00:00".toLDT, pClass = gtaskyellow, pRes = "Brian", pComp = 20, pOpen = Opening.open, pDepend = Seq(Depend(122))))
...
//                                                                        g.AddTaskItem(new TaskItemExt(pID = 333, pName = "Task Scrolling Grid", pStart = "2016-03-11 00:00".toLDT, pEnd = "2016-03-20 00:00".toLDT, pClass = gtaskblue, pRes = "Brian1", pParent = 33, pOpen = Opening.open, pDepend = Seq(Depend(332))))
...
//                                                                        g.AddTaskItem(new TaskItemExt(pID = 344, pName = "Draw Completion Div", pStart = "2016-05-17 00:00".toLDT, pEnd = "2016-06-04 00:00".toLDT, pClass = gtaskred, pRes = "Brian", pComp = 60, pParent = 34, pOpen = Opening.open, pDepend = Seq(Depend(342), Depend(343))))
//                                                                        g.AddTaskItem(new TaskItemExt(pID = 35, pName = "Make Updates", pStart = "2016-07-17 00:00".toLDT, pEnd = "2017-09-04 00:00".toLDT, pClass = gtaskpurple, pRes = "Brian", pComp = 30, pParent = 3, pOpen = Opening.open, pDepend = Seq(Depend(333))))
                                                                        g.Draw()
                                                                }
